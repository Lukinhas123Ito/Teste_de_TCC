...
const SignIn = () => {
  ...
  const { googleSignIn, githubSignIn, facebookSignIn, user, logIn } = UserAuth();
          ...
          <div className='w-full'>
            <div className='max-w-[650px] h-[600px] md:h-[400px] mx-auto text-zinc-800 rounded-md'>
              <div className='max-w-[420px] mx-auto px-6 py-12'>
                ...
                <h1 className='text-xl text-center font-bold mb-3'>Acesse sua conta</h1>
                ...
                <div className='my-3'>
                {error ? <p className='p-3 mb-5 text-red-500 border border-red-500 rounded my-2'>{error}</p> : null}
